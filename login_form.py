...
title_label = tk.Label(titleframe, text='Register', padx=20, pady=5, bg='green', fg='#fff', font=('Tahoma', 24),
                       width=8)
...
background_image = tk.PhotoImage(file="wallpapers.png")
background_label = tk.Label(login_contentframe, image=background_image)
background_label.place(x=0, y=0, relwidth=1, relheight=1)

username_label = tk.Label(login_contentframe, text='Username:', font=('Verdana', 16))
password_label = tk.Label(login_contentframe, text='Password:', font=('Verdana', 16))
...
login_button = tk.Button(login_contentframe, text="Login", font=('Verdana', 16), bg='#2980b9', fg='#fff',
